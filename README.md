...
Note that for reasons outlined below, the Green Line branches are all considered separate routes by this application. This
means that those stops that are on multiple branches of the Green Line and nothing else will show up under the #2 requirement.
